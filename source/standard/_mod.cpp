...
double __bnbcall modf( double _digit, double& _part )
{
    uint64 _i;
...
float __bnbcall modf( float _digit, float& _part )
{
    uint32 _i;
...
double __bnbcall fmod( double _x, double _y )
{
    uint64 _ix, _iy;
    ...
    uint64 _xs = _ix & 0x8000000000000000;
    _ix ^= _xs;
    _iy &= 0x7fffffffffffffff;

    if( 0 ==_iy
        || (_iy > 0x7ff0000000000000)
        || (_ix >= 0x7ff0000000000000) )
        return (_x * _y) / (_x * _y);
...
float __bnbcall fmod( float _x, float _y )
{
    uint32 _ix, _iy;
