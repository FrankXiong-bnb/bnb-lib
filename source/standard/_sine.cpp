...
double __bnbcall _sin( double _radian )
{
    if (_radian < 0)
        _radian -= ((int64)(_radian * _1_2pi - 0.5)) * _2pi;
    else
        _radian -= ((int64)(_radian * _1_2pi + 0.5)) * _2pi;
...
float __bnbcall _sin( float _radian )
{
    if (_radian < 0)
        _radian -= (float)(((int32)(_radian * _1_2pi - 0.5)) * _2pi);
    else
        _radian -= (float)(((int32)(_radian * _1_2pi + 0.5)) * _2pi);
...
double __bnbcall sin( double _radian )
{
...
float __bnbcall sin( float _radian )
{
    switch ( _check_numeral_type(_radian) )
    {
    case _nt_nan:
...
double __bnbcall cos( double _radian )
{
    switch ( _check_numeral_type(_radian) )
    {
    case _nt_nan:
...
float __bnbcall cos( float _radian )
{
    switch ( _check_numeral_type(_radian) )
    {
    case _nt_nan:
