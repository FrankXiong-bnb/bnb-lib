...
double __bnbcall _arctan( double _value )
{
...
float __bnbcall _arctan( float _value )
{
    bool _inverse = (_value > 1.0);
...
double __bnbcall arctan( double _value )
{
...
float __bnbcall arctan( float _value )
{
    switch ( _check_numeral_type(_value) )
    {
    case _nt_nan:
...
double __bnbcall arctan( double _oppside, double _adjside )
{
    double _radian = 0;
...
float __bnbcall arctan( float _oppside, float _adjside )
{
    float _radian = 0;
